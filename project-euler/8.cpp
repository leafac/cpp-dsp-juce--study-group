...
int main() {
  int numbersOfOperands = 13;
  long long largestProduct = 0;
  for (int numbersBaseIndex = 0;
       numbersBaseIndex < numbers.size() - numbersOfOperands;
       numbersBaseIndex++) {
    long long product = 1;
    for (int numbersOffset = 0; numbersOffset < numbersOfOperands;
         numbersOffset++)
      product *= numbers.at(numbersBaseIndex + numbersOffset);
